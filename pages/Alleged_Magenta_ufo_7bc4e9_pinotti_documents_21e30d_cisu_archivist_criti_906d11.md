...
show_ads: true
description: CISU's critique matters because it frames the Pinotti files as an archivistics problem, not just a UFO debate.
hero_summary: CISU's critique matters because it frames the Pinotti files as an archivistics problem, not just a UFO debate.
layout: default
permalink: /archivist-view/
sidebar_expanded_urls:
- /alleged-magenta-ufo/
- /pinotti-files/
nav_short_title: Archivist View
title: Why archivists doubt the Pinotti files
title_full: Why archivists doubt the Pinotti files
display_title_short: Archivist View
display_title: Archivist View
heading_title: Why archivists doubt the Pinotti files
page_heading_title: Why archivists doubt the Pinotti files
source_count: 28
infographic_count: 3
planned_sections:
- Who the CISU critique relies on
- Anonymous custody as an archival failure
- Why historical value depends on access and context
...
next_link:
  ...
  heading_title: Old paper is not an official record
header:
  og_image: /assets/images/Alleged_Magenta_ufo_7bc4e9_pinotti_documents_21e30d_cisu_archivist_criti_906d11-Illustration-1-social.jpg
  preview_image: /assets/images/Alleged_Magenta_ufo_7bc4e9_pinotti_documents_21e30d_cisu_archivist_criti_906d11-Illustration-1.webp
image: /assets/images/Alleged_Magenta_ufo_7bc4e9_pinotti_documents_21e30d_cisu_archivist_criti_906d11-Illustration-1-social.jpg
---
...
## Why archivists doubt the Pinotti files
...
CISU published an English translation of Carucci's professional opinion alongside Giuseppe Stilo's wider examination of the [Fascist UFO files]({{ 'fascist-files/' | relative_url }}). The organisation deliberately framed the discussion as an archival problem instead of a dispute between competing UFO researchers.

According to the CISU presentation of Carucci's analysis, several features prevent the documents from being accepted as archival records in the professional sense:
...
The strongest element of Carucci's critique concerns provenance and custody rather than handwriting, stamps or typography.
...
A further implication of the CISU critique is that historical evaluation requires more than access to reproductions or selected examples.

Professional historians and archivists ordinarily expect to examine:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* the complete archival series rather than isolated pages;
* accompanying registers, filing systems or inventories;
* evidence showing when and by whom records were created;
* related documents capable of confirming routine administrative activity.
...
<img src="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_pinotti_documents_21e30d_cisu_archivist_criti_906d11-Illustration-3-dark.svg" | relative_url }}" alt="Archivist View illustration 3" data-theme-src-dark="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_pinotti_documents_21e30d_cisu_archivist_criti_906d11-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_pinotti_documents_21e30d_cisu_archivist_criti_906d11-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why the archivist critique remains influential

Within discussions of the alleged Magenta crash, Carucci's opinion remains influential because it reframes the controversy from one of interpretation to one of documentary method.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly explains provenance, authenticity, context, and chain of custody used in critiques of disputed historical documents.</p>
        <div class="fr-book-actions">
