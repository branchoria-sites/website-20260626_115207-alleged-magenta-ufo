...
show_ads: true
description: Forensic checks can show whether a document could be old, but they cannot prove the event described actually happened.
hero_summary: Forensic checks can show whether a document could be old, but they cannot prove the event described actually happened.
layout: default
...
title: Can old paper prove a UFO claim?
title_full: Can old paper prove a UFO claim?
display_title_short: Paper Tests
display_title: Paper Tests
heading_title: Can old paper prove a UFO claim?
page_heading_title: Can old paper prove a UFO claim?
source_count: 13
infographic_count: 3
planned_sections:
- What material testing can examine
- Why dating is usually probabilistic
- How old materials can still carry false claims
...
image: /assets/images/Alleged_Magenta_ufo_7bc4e9_document_authenticat_1ab9aa_paper_ink_tests_82d500-Illustration-1-social.jpg
---
...
Forensic document examination combines chemistry, microscopy and traditional archival analysis to evaluate whether a document's physical characteristics match its claimed origin.

The most informative paper examinations include:
...
One common misconception is that laboratories can determine the exact year a document was written. In reality, forensic document dating is generally an exercise in estimating consistency rather than assigning a precise calendar date.
...
* the materials are consistent with a document from that period;
* the materials are inconsistent with that period; or
* there is insufficient evidence to reach a firm conclusion.

</div>

That distinction is important in assessing alleged historical UFO records.


<img src="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_document_authenticat_1ab9aa_paper_ink_tests_82d500-Illustration-2-dark.svg" | relative_url }}" alt="Paper Tests illustration 2" data-theme-src-dark="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_document_authenticat_1ab9aa_paper_ink_tests_82d500-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_document_authenticat_1ab9aa_paper_ink_tests_82d500-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How old materials can still carry false claims

Even if laboratory testing concludes that both paper and ink are genuinely old, the document's contents may still be inaccurate or fabricated.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/kCKM_ICjDtc" title="How the Secret Service Uses Ink to Solve Crimes" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=kCKM_ICjDtc" target="_blank" rel="noopener noreferrer">How the Secret Service Uses Ink to Solve Crimes</a></p><p class="youtube-embed-meta">Channel: Great Big Story</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=kCKM_ICjDtc" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=kCKM_ICjDtc">Open on YouTube</a></p></div></div></div>

## What paper and ink tests could reveal in alleged Magenta UFO files

Applied to alleged Fascist-era UFO papers associated with the Magenta case, material testing could address practical questions such as:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* whether the paper stock was manufactured during the claimed period;
* whether any watermark matches known Italian paper mills operating at the time;
* whether the ink chemistry is compatible with inks available in Fascist Italy;
* whether all pages were written using the same ink or at the same time;
* whether signatures, annotations or stamps were added later;
* whether pages have been substituted or assembled from different documents.

</div>

These findings would establish whether the physical object is internally consistent with its claimed history. They would not demonstrate that any reported UFO recovery, government programme or extraordinary event actually occurred.


<img src="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_document_authenticat_1ab9aa_paper_ink_tests_82d500-Illustration-3-dark.svg" | relative_url }}" alt="Paper Tests illustration 3" data-theme-src-dark="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_document_authenticat_1ab9aa_paper_ink_tests_82d500-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_document_authenticat_1ab9aa_paper_ink_tests_82d500-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The limits of physical authentication
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/PI5PP_08nOs" title="Forensic Ink Analysis" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=PI5PP_08nOs" target="_blank" rel="noopener noreferrer">Forensic Ink Analysis</a></p><p class="youtube-embed-meta">Channel: Graham Reed</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=PI5PP_08nOs" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=PI5PP_08nOs">Open on YouTube</a></p></div></div></div>
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Foundational methods for authentication.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses paper, ink and document testing.</p>
        <div class="fr-book-actions">
