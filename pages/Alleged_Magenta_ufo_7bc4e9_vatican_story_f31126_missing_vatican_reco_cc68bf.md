...
show_ads: true
description: No authenticated Vatican archive record has surfaced tying the Holy See to a recovered craft, Cabinet RS/33, or a transfer to America.
hero_summary: No authenticated Vatican archive record has surfaced tying the Holy See to a recovered craft, Cabinet RS/33, or a transfer to America.
layout: default
...
title: Why Are the Vatican Records Missing?
title_full: Why Are the Vatican Records Missing?
display_title_short: Archive Gap
display_title: Archive Gap
heading_title: Why Are the Vatican Records Missing?
page_heading_title: Why Are the Vatican Records Missing?
source_count: 43
infographic_count: 3
planned_sections:
- What Vatican records would need to show
- Public statements from Vatican archivists
...
next_link:
  ...
  heading_title: Could the Retrieval Timeline Work?
header:
  og_image: /assets/images/Alleged_Magenta_ufo_7bc4e9_vatican_story_f31126_missing_vatican_reco_cc68bf-Illustration-1-social.jpg
  preview_image: /assets/images/Alleged_Magenta_ufo_7bc4e9_vatican_story_f31126_missing_vatican_reco_cc68bf-Illustration-1.webp
image: /assets/images/Alleged_Magenta_ufo_7bc4e9_vatican_story_f31126_missing_vatican_reco_cc68bf-Illustration-1-social.jpg
---
...
* Correspondence indicating that Vatican officials received credible reports of an unusual recovered object from Fascist authorities.
* Diplomatic communications showing Pope Pius XII or senior officials discussing such an object with Allied governments.
* Internal memoranda recording decisions to relay information outside the Vatican.
* References in related wartime diplomatic files that could corroborate contacts described in later accounts.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/2CB7lBRZPew" title="Is the Vatican sitting on UFO documentation? | Banfield" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=2CB7lBRZPew" target="_blank" rel="noopener noreferrer">Is the Vatican sitting on UFO documentation? | Banfield</a></p><p class="youtube-embed-meta">Channel: NewsNation</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=2CB7lBRZPew" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=2CB7lBRZPew">Open on YouTube</a></p></div></div></div>

## What Vatican officials and archivists have said
...
## Why the absence is not proof—but still matters

A common misunderstanding is to treat missing records as either definitive disproof or implicit confirmation. Neither conclusion follows automatically.

There are several reasons why records might not be available:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* A claimed event never occurred.
* Relevant documents were never created.
* Records were destroyed during wartime or later administrative processes.
* Documents remain unidentified within very large archival collections.
* The claim has been embellished beyond anything reflected in contemporary records.

</div>

Because several explanations are possible, the absence of evidence cannot logically establish that the Vatican never discussed unusual reports. However, the stronger and more detailed the historical claim becomes, the greater the expectation that some independent documentation should exist.

This distinction is especially important because the Vatican intermediary story is highly specific. It is not merely a suggestion that Church officials heard rumours. It alleges identifiable actors, an identifiable period, a diplomatic channel and an alleged transfer with major geopolitical consequences. Claims at that level of specificity normally become easier—not harder—to test against archival sources.


<img src="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_vatican_story_f31126_missing_vatican_reco_cc68bf-Illustration-2-dark.svg" | relative_url }}" alt="Archive Gap illustration 2" data-theme-src-dark="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_vatican_story_f31126_missing_vatican_reco_cc68bf-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_vatican_story_f31126_missing_vatican_reco_cc68bf-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why the archive gap affects the credibility of the intermediary story

The missing archival trail has consequences beyond the Vatican itself.
...
The current [evidence gap]({{ 'evidence-gap/' | relative_url }}) is not necessarily permanent. A substantially different assessment would become possible if researchers were able to authenticate primary documents such as:

* wartime Vatican diplomatic correspondence explicitly describing the alleged recovered craft;
* verified archival records linking Pope Pius XII to discussions of the Magenta incident;
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps readers understand how the Vatican operates and communicates historically.</p>
        <div class="fr-book-actions">
