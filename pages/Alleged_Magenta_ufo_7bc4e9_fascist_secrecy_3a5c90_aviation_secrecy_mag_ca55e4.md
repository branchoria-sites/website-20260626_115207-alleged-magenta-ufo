...
show_ads: true
description: Inter-war aviation secrecy makes a hidden aircraft recovery plausible in theory, but it cannot authenticate the Magenta story.
hero_summary: Inter-war aviation secrecy makes a hidden aircraft recovery plausible in theory, but it cannot authenticate the Magenta story.
layout: default
permalink: /aviation-secrecy/
sidebar_expanded_urls:
- /alleged-magenta-ufo/
- /secrecy/
nav_short_title: Aviation secrecy
title: Why aviation secrecy matters to Magenta
title_full: Why aviation secrecy matters to Magenta
display_title_short: Aviation secrecy
display_title: Aviation secrecy
heading_title: Why aviation secrecy matters to Magenta
page_heading_title: Why aviation secrecy matters to Magenta
source_count: 41
infographic_count: 3
planned_sections:
...
* **Press [censorship]({{ 'censorship/' | relative_url }}).** Newspapers operated under Fascist [oversight]({{ 'oversight/' | relative_url }}), allowing reports involving military embarrassment or sensitive technology to be delayed, altered or suppressed.
...
<img src="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_fascist_secrecy_3a5c90_aviation_secrecy_mag_ca55e4-Illustration-2-dark.svg" | relative_url }}" alt="Aviation secrecy illustration 2" data-theme-src-dark="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_fascist_secrecy_3a5c90_aviation_secrecy_mag_ca55e4-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alleged_Magenta_ufo_7bc4e9_fascist_secrecy_3a5c90_aviation_secrecy_mag_ca55e4-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Where the Magenta argument goes beyond the evidence

[Supporters]({{ 'supporters/' | relative_url }}) of the Magenta case sometimes argue that the absence of public records is itself consistent with an effective military cover-up. This reasoning has intuitive appeal because authoritarian governments do suppress information.
